  ...
  themeConfig: {
    locales:{
      ...
      '/ch/':{
       ...
       displayAllHeaders: true, // 默认值：false
       sidebar: [
          ['/ch/Introduction_ch.md','OpenNCC介绍'],
          ['/ch/HardwareManual_ch.md','OpenNCC 硬件手册'],
          ['/ch/GettingStart_ch.md','OpenNCC 快速开始'],
          ['/ch/NccView_ch.md','OpenNCC View说明'],
          ['/ch/SoftwareManual_ch.md','软件开发包手册'],
          ['/ch/SdkApi_ch.md','OpenNCC SDK接口文档'],
          ['/ch/OpenvinoInstall_ch.md','OpenVINO安装说明'],
          ['/ch/DownloadLink_ch.md','安装包和源码下载地址'],
          ['/ch/FAQ_ch.md', '常见问题'],
        ],
      }
    }
