...
class SensorModesConfig(_object):
    ...
    if _newclass:
        moduleName = _swig_property(_openncc.SensorModesConfig_moduleName_get, _openncc.SensorModesConfig_moduleName_set)
...
_openncc.F32_RND_MINUS_INF_swigconstant(_openncc)
F32_RND_MINUS_INF = _openncc.F32_RND_MINUS_INF

_openncc.F32_RND_PLUS_INF_swigconstant(_openncc)
F32_RND_PLUS_INF = _openncc.F32_RND_PLUS_INF

_openncc.F32_RND_TO_ZERO_swigconstant(_openncc)
F32_RND_TO_ZERO = _openncc.F32_RND_TO_ZERO

_openncc.F32_DETECT_TINY_AFTER_RND_swigconstant(_openncc)
F32_DETECT_TINY_AFTER_RND = _openncc.F32_DETECT_TINY_AFTER_RND

_openncc.F32_DETECT_TINY_BEFORE_RND_swigconstant(_openncc)
F32_DETECT_TINY_BEFORE_RND = _openncc.F32_DETECT_TINY_BEFORE_RND

_openncc.F32_EX_INEXACT_swigconstant(_openncc)
F32_EX_INEXACT = _openncc.F32_EX_INEXACT

_openncc.F32_EX_DIV_BY_ZERO_swigconstant(_openncc)
F32_EX_DIV_BY_ZERO = _openncc.F32_EX_DIV_BY_ZERO

_openncc.F32_EX_INVALID_swigconstant(_openncc)
F32_EX_INVALID = _openncc.F32_EX_INVALID

_openncc.F32_EX_UNDERFLOW_swigconstant(_openncc)
F32_EX_UNDERFLOW = _openncc.F32_EX_UNDERFLOW

_openncc.F32_EX_OVERFLOW_swigconstant(_openncc)
F32_EX_OVERFLOW = _openncc.F32_EX_OVERFLOW

_openncc.F32_NAN_DEFAULT_swigconstant(_openncc)
