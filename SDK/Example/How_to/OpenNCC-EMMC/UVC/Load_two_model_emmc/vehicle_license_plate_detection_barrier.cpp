...
//        printf("x1,y1,x2,y2:%d %d %d %d\n",box.x,box.y,box.width,box.height );
	...
	extern float  nccFps;
	extern float  sensorFps;
	char fpssrc[256];
	sprintf(fpssrc, "Camera:%3.1f FPS, NCC: %3.1f FPS ", sensorFps,nccFps);
	cv::putText(outgoingImage, fpssrc, cv::Point2f(0, 120), cv::FONT_HERSHEY_TRIPLEX, 1,
