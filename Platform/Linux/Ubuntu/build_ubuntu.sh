...
echo "This script will overwrite this workspace !"
...
if [ ! -d "Source/Library/" ];then
	...
	cp -r $SDK_BASE_PATH/SDK/Source/Library/Linux/$project_name ./Source/Library
...
if [ ! -d "Source/Firmware/" ];then
	...
	if [ ! -d "Source/Firmware/fw" ];then

		cp $SDK_BASE_PATH/SDK/Source/Firmware/fw/ Source/Firmware/
