...
if [ ! -d "Source/Library/" ];then
	...
	mkdir ./Source/Library/C\&C++
	cp ../../SDK/Source/Library/Custom/C\&C++/moviUsbBoot ./Source/Library/C\&C++
	cp -r ../../SDK/Source/Library/Custom/* ./Source/Library/C\&C++
else
...
if [ -f "/Source/Library/C\&C++/libOpenNCC.a" ];then
	echo "cp lib"
